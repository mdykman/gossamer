...
public class SQLiteProfileFactory implements ApplicationContextAware, DeviceProfileFactory {
	...
	private Integer resolveByLabel( String label)
	{
		...
		try {
			...
			PreparedStatement lookupSt = connection.prepareStatement("select did from devices where device_id = ?");
